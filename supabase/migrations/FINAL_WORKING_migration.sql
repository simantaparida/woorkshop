-- Final Working Migration for Problem Framing
-- This handles all edge cases properly

-- ============================================================================
-- CLEANUP: Only drop things that actually exist
-- ============================================================================

DO $$
BEGIN
  -- Drop tables (CASCADE handles all dependent objects: indexes, triggers, policies)
